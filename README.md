...
<body>
  <table class="layout">
    ...
    <tr>
      <td colspan="2">
        <div class="marquee-row">
          <marquee>Добро пожаловать на Buffalo County Times. Сегодня 14 октября 2001 года.</marquee>
        </div>
